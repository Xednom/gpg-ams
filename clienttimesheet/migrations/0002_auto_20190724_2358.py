# Generated by Django 2.1.2 on 2019-07-24 15:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameField(
            ...
            new_name='channel_job_requested',
        ),
        migrations.RenameField(
            model_name='timesheet',
            old_name='month_to_date',
            new_name='first_month_to_date',
        ),
        migrations.RenameField(
            model_name='timesheet',
            old_name='amount_charge',
            new_name='hourly_rate_peso',
        ),
        migrations.RenameField(
            model_name='timesheet',
            old_name='hourly_rate',
            new_name='total_charge_peso',
        ),
        ...
        migrations.AddField(
            model_name='timesheet',
            name='admin_approval',
            field=models.CharField(choices=[('Approved', 'Approved'), ('Declined', 'Declined'), ('Dispute', 'Dispute'), ('Waived', 'Waived')], default='For Review', max_length=50),
        ),
        migrations.AddField(
            model_name='timesheet',
            name='assigned_pm',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='pms', to='users.Staffs', verbose_name='Assigned Project Manager'),
        ),
        migrations.AddField(
            model_name='timesheet',
            name='assigned_va',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vas', to='users.Staffs', verbose_name='Assigned VA'),
        ),
        migrations.AddField(
            model_name='timesheet',
        ...
        migrations.AlterField(
            model_name='timesheet',
            name='status',
            field=models.CharField(choices=[('Approved', 'Approved'), ('For Review', 'For Review'), ('Dispute', 'Dispute'), ('Waived', 'Waived')], default='For Review', max_length=50),
        ),
        migrations.AlterField(
            model_name='timesheet',
