...
class DueDiligence(TimeStampedModel):
    ...
    google_map_link = models.CharField(max_length=250, null=True, blank=True)
    ...
    zoning_department_website = models.CharField(max_length=250, null=True, blank=True)
    gis_website = models.CharField(max_length=250, null=True, blank=True, verbose_name="GIS Website")
    cad_website = models.CharField(max_length=250, null=True, blank=True, verbose_name="CAD Website")
