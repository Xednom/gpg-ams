...
class DueDiligence(TimeStampedModel):
    ...
    gps_coordinates = models.TextField(null=True, blank=True, verbose_name="GPS Coordinates")
    gps_coordinates_4_corners = models.TextField(null=True, blank=True, verbose_name="GPS Coordinates 4 Corners")
    ...
    assessor_website = models.TextField(null=True, blank=True)
    treasurer_website = models.TextField(null=True, blank=True)
    recorder_clerk_website = models.TextField(null=True, blank=True, verbose_name="Recorder/Clerk Website")
    zoning_department_website = models.TextField(null=True, blank=True)
    gis_website = models.TextField(null=True, blank=True, verbose_name="GIS Website")
    cad_website = models.TextField(null=True, blank=True, verbose_name="CAD Website")
    ...
    time_limit_to_build = models.TextField(null=True, blank=True, help_text="Is there any time limit to build?")
